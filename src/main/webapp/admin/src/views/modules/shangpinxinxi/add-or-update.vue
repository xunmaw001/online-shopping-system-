          ...
          <el-form-item class="input" label="尺码" prop="chima">
              <el-input v-model="ruleForm.chima" 
                placeholder="尺码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="颜色" prop="yanshe">
          <el-input v-model="ruleForm.yanshe" 
              placeholder="颜色" clearable  :readonly="ro.yanshe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="颜色" prop="yanshe">
              <el-input v-model="ruleForm.yanshe" 
